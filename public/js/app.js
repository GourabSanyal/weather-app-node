...
function isWeatherError(response) {
    return 'error' in response;
}
// Get DOM elements with type safety
var weatherForm = document.querySelector('#weather-form');
var search = document.querySelector('#location-input');
...
weatherForm.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
    var location, response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                e.preventDefault();
                location = search.value.trim();
                if (!location) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch("/weather?address=".concat(encodeURIComponent(location)))];
            case 2:
                response = _a.sent();
